...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "VAMPPangleAdapter",
                      url: "https://d2dylwb3shzel1.cloudfront.net/iOS/VAMPPangleAdapter-v7.4.10100.zip",
                      checksum: "587114011b572e33a08b1501d45caea98539c209f5fc80ad30ff92ae835526d0")
    ]
)
